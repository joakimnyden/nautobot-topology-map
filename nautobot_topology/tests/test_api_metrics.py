...
class TopologyMetricsTest(TestCase):
    ...
    def test_metrics_mock_enabled(self, mock_cable_filter, mock_device_filter, mock_get_locs, mock_get_loc, mock_getattr):
    ...
    @patch('nautobot_topology.api.views.Device.objects.filter')
    @patch('nautobot_topology.api.views.Cable.objects.filter')
    def test_metrics_cable_missing_device(self, mock_cable_filter, mock_device_filter, mock_get_locs, mock_get_loc, mock_getattr):
        mock_getattr.return_value.get.return_value = {'prometheus_enabled': True, 'prometheus_url': 'mock'}
        mock_site = MagicMock()
        mock_get_loc.return_value = mock_site
        mock_get_locs.return_value = [mock_site]
    ...
    @patch('nautobot_topology.api.views.Device.objects.filter')
    @patch('nautobot_topology.api.views.Cable.objects.filter')
    def test_metrics_prometheus_query(self, mock_cable_filter, mock_device_filter, mock_get_locs, mock_requests_get, mock_get_loc, mock_getattr):
    ...
    @patch('nautobot_topology.api.views.Device.objects.filter')
    @patch('nautobot_topology.api.views.Cable.objects.filter')
    def test_metrics_prometheus_error(self, mock_cable_filter, mock_device_filter, mock_get_locs, mock_requests_get, mock_get_loc, mock_getattr):
        mock_getattr.return_value.get.return_value = {
            'prometheus_enabled': True,
            'prometheus_url': 'http://prom:9090',
