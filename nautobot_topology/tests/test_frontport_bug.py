...
class FrontPortBugTest(TestCase):
    ...
    def test_retrieve_frontport_link(self, mock_prefix_filter, mock_vlan_filter, mock_cable_filter, mock_device_filter, mock_get_locs, mock_get_loc, mock_fp_filter, mock_iface_filter):
        mock_site = MagicMock()
