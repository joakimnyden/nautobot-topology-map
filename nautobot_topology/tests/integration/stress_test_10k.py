...
from nautobot.dcim.models import Device, DeviceType, Location, LocationType, Manufacturer, Interface, Cable
        ...
        for ds in dist_switches:
            ...
            for cs in targets:
                ...
                if iface_a and iface_b:
                    cables.append(Cable(
                        termination_a=iface_a,
                        termination_b=iface_b,
                        status=active_status
                    ))
