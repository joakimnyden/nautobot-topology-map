...
class TopologyMetricsTest(TestCase):
    ...
    def test_metrics_mock_enabled(
        self, mock_cable_filter, mock_device_filter, mock_get_locs, mock_get_loc, mock_getattr
    ):
    ...
    def test_metrics_prometheus_query(
        self, mock_cable_filter, mock_device_filter, mock_get_locs, mock_requests_get, mock_get_loc, mock_getattr
    ):
