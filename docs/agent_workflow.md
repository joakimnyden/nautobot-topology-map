...
- **API Namespace**: The plugin API is registered under the `nautobot_topology` namespace. Always use `reverse('plugins-api:nautobot_topology:<viewname>')` for URL resolution in tests and backend code.
